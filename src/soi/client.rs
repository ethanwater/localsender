...
//what the fuck is the point of this function? It's terribly unsafe and therefore pointless. I mean, why would someone even pen the fucking thing if theres no file that exists like cmmon
//
//
